                ...
                >
                    ...
                    <form class="flex flex-col gap-3" @submit.prevent="handleSubmit">
                        <div v-if="isRegistering" class="flex flex-col gap-1.5">
                            <Label class="text-[12px] text-[var(--hig-secondary-label)]" for="username">用户名</Label>
                            <Input
                                id="username"
                        ...
                        <div class="flex flex-col gap-1.5">
                            <Label class="text-[12px] text-[var(--hig-secondary-label)]" for="email">邮箱</Label>
                            <Input
                                id="email"
                                v-model="form.email"
                                type="email"
                        ...
                        <div class="flex flex-col gap-1.5">
                            <Label class="text-[12px] text-[var(--hig-secondary-label)]" for="password">密码</Label>
                            <div class="relative">
                                <Input
                                    id="password"
